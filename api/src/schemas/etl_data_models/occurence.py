...
class OccurrenceBase(Model):
    ...
    degree_of_establishment: Optional[str] = Field(
        None, description="Degree of establishment of the occurrence"
    )
    media_id: Optional[UUID4] = Field(
        None, description="Media identifier associated with the occurrence"
    )
    taxa_id: Optional[UUID4] = Field(
        None, description="Taxa identifier associated with the occurrence"
    )
    location_id: Optional[UUID4] = Field(
        None, description="Location identifier associated with the occurrence"
    )
    identification_id: Optional[UUID4] = Field(
        None, description="Identification identifier associated with the occurrence"
    )
