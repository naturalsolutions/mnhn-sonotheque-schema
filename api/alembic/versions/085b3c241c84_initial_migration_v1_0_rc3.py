"""Initial migration v1.0.rc3

Revision ID: 085b3c241c84
Revises: 43d069387dc7
Create Date: 2024-08-16 15:51:07.459004
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("device_id", "media_file_id", "id"),
    )
    op.create_table(
        "identifications",
        sa.Column("id", sa.UUID(), nullable=False),
